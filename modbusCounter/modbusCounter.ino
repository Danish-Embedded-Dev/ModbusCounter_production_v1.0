...
//        while(!Serial); 
        ...
        if(internal_flash.get_struct_var(&running_var,sizeof(running_var))){
          ...
          internal_flash.get_struct_var(&running_var,sizeof(running_var)); //read from the flash and update running variable
        } 
        
         DEBUG_PRINT("running_var.device_id   : "); DEBUG_PRINTLN(running_var.device_id); 
         DEBUG_PRINT("running_var.mod_config  : "); DEBUG_PRINTLN(running_var.mod_config); 
         DEBUG_PRINT("running_var.mod_baud    : "); DEBUG_PRINTLN(running_var.mod_baud); 
         DEBUG_PRINT("running_var.net_timeout : "); DEBUG_PRINTLN(running_var.net_timeout); 
         DEBUG_PRINT("running_var.debounce_tm : "); DEBUG_PRINTLN(running_var.debounce_tm);  
         DEBUG_PRINT("running_var.count_1     : "); DEBUG_PRINTLN(running_var.count_1);
         DEBUG_PRINT("running_var.count_2     : "); DEBUG_PRINTLN(running_var.count_2);
